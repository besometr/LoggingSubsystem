...
// TODO В Пегасе Заменить на имеющийся аналог.
...
// ЗаполнитьПараметрыПодключенияКELK
// Интерфейс для функции ЗаполнитьПараметрыПодключенияКELK
//
// Параметры:
...
//
Функция ЗаполнитьПараметрыПодключенияКELK(СтруктураПараметровПодключения, ТипНастройкиПодключенияКELK)Экспорт 
	
	Возврат ЛогированиеСервер.ЗаполнитьПараметрыПодключенияКELKСервер(СтруктураПараметровПодключения, ТипНастройкиПодключенияКELK);
	
КонецФункции

// ЗаписатьПараметрыПодключенияКELK
// Интерфейс для функции ЗаписатьПараметрыПодключенияКELKСервер
//
// Параметры:
//	СтруктураПараметровПодключения	- Структура	- Параметры подключения к ELK.
...
//	Отказ		- Булево	- Признак возникновения ошибки выполнения.
//
Процедура ЗаписатьПараметрыПодключенияКELK(СтруктураПараметровПодключения, ТекстОшибки = "", Отказ = Ложь)Экспорт 
	
	ЛогированиеСервер.ЗаписатьПараметрыПодключенияКELKСервер(СтруктураПараметровПодключения, ТекстОшибки, Отказ);
