...
//
// Глобальный модуль.
// Содержит единые точки входа для записи и чтения логов.
// 
// Подсистема Логирования ELK подразумевает работу со стеком приложений: 
// Elasticsearch, Logstash и Kibana. Подробнее о данных продуктах можно узнать здесь:
// https://www.elastic.co/elk-stack
//
// Объекты подсистемы позволяют записывать и читать логи из базы данных 
////////////////////////////////////////////////////////////////////////////////
