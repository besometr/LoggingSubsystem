...
Функция КонструкторСтруктурыПользовательскихПолейЛога(КороткоеСообщение = "", 
	...
	СтруктураПользовательскихПолейЛога.Вставить("ДатаСобытия",			?(ЗначениеЗаполнено(ДатаСобытия), ДатаСобытия, УниверсальноеВремя(ТекущаяДата())));
	...
	//
	ФиксированнаяСтруктураПользовательскихПолейЛога = Новый ФиксированнаяСтруктура(СтруктураПользовательскихПолейЛога);
		
	Возврат ФиксированнаяСтруктураПользовательскихПолейЛога;
